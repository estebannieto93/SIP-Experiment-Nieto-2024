...
fully.process<-function(forward_read_names="_L001_R1_001.fastq.gz", reverse_read_names="_L001_R2_001.fastq.gz", seed=1, displayx=10, filetype=".jpg",trimleft=10, maxeef=5, maxeer=5,trainingset="silva_132.18s.99_rep_set.dada2.fa.gz", truncLenF=220, truncLenR=190, tree=FALSE,multithread=TRUE, loopnr=1){
